    ...
    <div class="card-body">
        ...
        <form id="eventForm" enctype="multipart/form-data">
            <div class="row g-3">
                ...
                <div class="col-md-4">
                    <label class="form-label">Max Capacity <small>(write 0 for unlimited)</small></label>
                ...
                <div class="col-md-6">
                    <label class="form-label">Ticket Price <small>(write 0 for free event)</small></label>
...
document.getElementById('eventForm').addEventListener('submit', async function(e) {
    ...
    try {
        ...
        const result = await updateEvent(formData, '<?= $event['slug'] ?>');
